                ...
                <form class="form-horizontal la" id="submit-form" action="<?= ($BASE) ?>/user" method="<?= ($method) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label for="admin">ແອັດມິນ</label><br>
                            <input type="radio" id="emp_meter" name="role" value="emp_meter">
                            <label for="emp_meter">ພະນັກງານຈົດເລກກົງເຕີ</label><br>
                            <input type="radio" id="emp_finance" name="role" value="emp_finance">
                            <label for="emp_finance">ພະນັກງານເກັບເງິນ</label>
                            <div class="error"></div>
                        </div>
                    </div>
