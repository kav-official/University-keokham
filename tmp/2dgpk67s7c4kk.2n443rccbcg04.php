          ...
          <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
              <div class="ibox-title text-right la">
                <a href="<?= ($BASE) ?>/report-product/pdf" class="btn btn-success">PDF ລາຍງານ</a>
              </div>
                ...
                <table class="table table-striped table-bordered table-hover datatables-content">
                  <thead>
                    <tr>
                      ...
                      <th class="la" style="font-family: Noto Sans Lao;">ຜູ້ສະໜອງ</th>
                      ...
                      <th class="la" style="font-family: Noto Sans Lao;">ວັນທີສ້າງ</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php $ctr=0; foreach (($items?:[]) as $row): $ctr++; ?>
                    <tr id="item-<?= ($row['id']) ?>">
                      ...
                      <td><?= (date('d/m/Y H:i:s A', strtotime($row['date_expirt']))) ?></td>
