<nav class="navbar-default navbar-static-side la" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="<?= ($nav=='report-product' ? 'active' : '') ?> || <?= ($nav=='report-expirt-date' ? 'active' : '') ?> || <?= ($nav=='report-order' ? 'active' : '') ?> || <?= ($nav=='report-sale' ? 'active' : '') ?>">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="<?= ($subnav=='report-expirt-date' ? 'active' : '') ?> la"><a href="<?= ($BASE) ?>/report/expirt-date">👥 ລາຍງານໝົດອາຍ</a></li>
                    <li class="<?= ($subnav=='report-order' ? 'active' : '') ?> la"><a href="<?= ($BASE) ?>/report/order">💱  ລາຍງານການສັໍ່ງຊື້</a></li>
                    <li class="<?= ($subnav=='report-sale' ? 'active' : '') ?> la"><a href="<?= ($BASE) ?>/report/sale">📪 ລາຍງານການຂາຍ</a></li>
                </ul>
            </li> 
