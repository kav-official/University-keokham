        ...
        <div class="wrapper wrapper-content">
          <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">            
                <form class="form-horizontal la" id="submit-form" action="<?= ($BASE) ?>/category" method="<?= ($method) ?>">
                    <input type="hidden" name="id" value="<?= ($id ?? '') ?>">
                    <div class="form-group"><label class="col-sm-2 control-label">ພະເພດສິນຄ້າ</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            ...
                            <a class="btn btn-white ls" href="<?= ($BASE) ?>/category">ຍົກເລີກ</a>                                        
                        </div>
                    </div>
                </form>
            </div>
